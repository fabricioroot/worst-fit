...
public class MainScreen extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jPanelIntroductionLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPaneIntroduction, javax.swing.GroupLayout.DEFAULT_SIZE, 970, Short.MAX_VALUE)
        );
        ...
        jPanelAlgorithmLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPaneAlgorithm, javax.swing.GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
        );
    ...
    private void jButtonIntroductionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIntroductionActionPerformed
        final String TEXT_BASE_INTRODUCTION = "\n" +
                                              ...
                                              "* Este software Educativo trata da política WORST-FIT (o pior que couber):\n" +
                                              "Esta política procura pela maior partição livre para armazenar o processo requerente por memória. Após escolher uma partição livre grande,\n" +
                                              "o seu restante será suficientemente grande para alocar um novo processo.\n\n" +
                                              "* VEJA O ALGORITMO ABAIXO.";
        final String TEXT_BASE_ALGORITHM = "funcao worstFit (vetor<TAD_CelulaMemoria> memoria, TAD_Processo processo) : Vetor<TAD_CelulaMemoria>\n" +
                                           "inicio\n" +
    ...
    private void jButtonAlgorithmStepsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlgorithmStepsActionPerformed
        ...
        if(algorithmResult != null) {
            ...
            if(finalPositionBlocks <= 15) {
                for(j = 0; j <= (finalPositionBlocks - 1); j++){
                ...
                if((finalPositionBlocks > 15) && (finalPositionBlocks <= 30)) {
                    ...
                    // Second row
                    for(j = 0; j <= (finalPositionBlocks - 16); j++){
                    ...
                    if((finalPositionBlocks > 30) && (finalPositionBlocks <= 45)){
                        ...
                        // third row
                        for(j = 0; j <= (finalPositionBlocks - 31); j++){
            ...
            if(worsePositions.size() > 1) {
                ...
                if(worsePositions.size() == 2) {
                    ...
                    block1.setToolTipText(String.valueOf(process.getSize()));
                    ...
                    if((initialPositionBlocks <= 15) && (finalPositionBlocks >= initialPositionBlocks)){
                        if(finalPositionBlocks <= 15) {
                            for(j = (initialPositionBlocks - 1); j <= (finalPositionBlocks - 1); j++){
                            ...
                            if((finalPositionBlocks > 15) && (finalPositionBlocks <= 30)) {
                                // First row
                                for(j = (initialPositionBlocks - 1); j <= 14; j++){
                                    block1.setBounds(20+(j*35), orientationAxisY, 30, 30);
                                    JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                                }
                                // Second row
                    ...
                    if((initialPositionBlocks > 15) && (initialPositionBlocks <= 30) && (finalPositionBlocks >= initialPositionBlocks)){
                        if(finalPositionBlocks <= 30) {
                            // Second row
                            for(j = (initialPositionBlocks - 16); j <= (finalPositionBlocks - 16); j++){
                                block1.setBounds(20+(j*35), (orientationAxisY + 60), 30, 30);
                                JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                            }
                        }
                            ...
                            if((finalPositionBlocks > 30) && (finalPositionBlocks <= 45)){
                                // Second row
                                for(j = (initialPositionBlocks - 16); j <= 14; j++){
                                    block1.setBounds(20+(j*35), (orientationAxisY + 60), 30, 30);
                                    JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                                }
                                // third row
                    ...
                    if((initialPositionBlocks > 30) && (initialPositionBlocks <= 45) && (finalPositionBlocks >= initialPositionBlocks)){
                        for(j = (initialPositionBlocks - 31); j <= (finalPositionBlocks - 31); j++){
                            block1.setBounds(20+(j*35), (orientationAxisY + 120), 30, 30);
                            JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                        }
                    }
                        ...
                        if((initialPositionBlocks > 30) && (initialPositionBlocks <= 45) && (finalPositionBlocks < initialPositionBlocks)){
                            if(finalPositionBlocks <= 15) {
                                // Third Row
                                for(j = (initialPositionBlocks - 31); j <= 14; j++){
                                    block1.setBounds(20+(j*35), (orientationAxisY + 120), 30, 30);
                                    JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                                }
                                // Going back ... First row
                ...
                // 'worsePositions.size() > 2', thus there are more than 2 possible "better positions"
                else {
                    int t = 0;
                    do {
                        initialPositionBlocks = finalPositionBlocks;
                        ...
                        block2.setToolTipText(String.valueOf(process.getSize()));
            ...
            block3.setToolTipText(String.valueOf(process.getSize()));
    ...
    public void paintProcessesQueue(Vector<Process> processesQueue) {
        ...
        for(int i = 0; i <= (processesQueue.size() - 1); i++) {
            ...
            if (i <= 6) {
                block.setBounds(20+(i*35), orientationAxisY - 10, 30, 30);
            }
            else {
                if (i <= 13) {
                    block.setBounds(20+((i - 7)*35), orientationAxisY + 30, 30, 30);
                }
            }
        }
    }
